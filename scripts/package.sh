...
cp "$DIST/apple-touch-icon.png" "$STAGING/dist/apple-touch-icon.png"
cp "$DIST/favicon.ico" "$STAGING/dist/favicon.ico"
cp "$DIST/site.webmanifest" "$STAGING/dist/site.webmanifest"
cp "$DIST/web-app-manifest-192x192.png" "$STAGING/dist/web-app-manifest-192x192.png"
cp "$DIST/web-app-manifest-512x512.png" "$STAGING/dist/web-app-manifest-512x512.png"
