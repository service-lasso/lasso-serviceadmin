...
PORT=17711 SERVICE_PORT=17711 SERVICE_HOST=127.0.0.1 SERVICE_LASSO_API_BASE_URL=http://127.0.0.1:17712 node ./runtime/server.js > /tmp/@serviceadmin-test.log 2>&1 &
SERVER_PID=$!
